...
cd ~
echo 'xhdtlsqhdks1' | sudo -kS curl -sL https://rpm.nodesource.com/setup_12.x | sudo -E bash -
echo 'xhdtlsqhdks1' | sudo -kS yum -y install nodejs

# git clone server setting forder (1,2,3)]
cd ~
cd /home/atcs02/centerservercicd/server2
npm install dotenv
...
\cp /home/atcs02/centerservercicd/server2/zoo.cfg /home/atcs02/app/zookeeper/conf/zoo.cfg
...
echo 'xhdtlsqhdks1' | sudo -kS cp /home/atcs02/centerservercicd/server2/zookeeper-server.service /usr/lib/systemd/system/zookeeper-server.service
...
\cp /home/atcs02/centerservercicd/server2/server.properties /home/atcs02/app/kafka/config/server.properties
# [zookeeper.properties] file setting
\cp /home/atcs02/centerservercicd/server2/zookeeper.properties /home/atcs02/app/kafka/config/zookeeper.properties
...
echo 'xhdtlsqhdks1' | sudo -kS cp /home/atcs02/centerservercicd/server2/kafka-server.service /usr/lib/systemd/system/kafka-server.service
echo 'xhdtlsqhdks1' | sudo -kS systemctl daemon-reload
